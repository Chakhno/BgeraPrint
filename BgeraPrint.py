...
if not CONFIG_PATH.exists():
    ...
    while True:
        ...
        potential_path = PRINTER_CONFIGS / f"{printer}.ini"
...
PRINT_CONFIG = PRINTER_CONFIGS / f"{PRINTER}.ini"
...
def model_dim_audio(STL_FILE, lingo, ans):
    ...
    if lingo == 'georgian':
        ...
        if ans == 'm':
            ...
            text = f"Dimensions of {ans} are {dimensions}. You can scale the model by typing the scale number or press P and Enter to initiate printing-procedures."
        else:
